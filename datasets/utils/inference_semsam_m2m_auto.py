...
def inference_semsam_m2m_auto(model, image, level, all_classes, all_parts, thresh, text_size, hole_scale, island_scale, semantic, refimg=None, reftxt=None, audio_pth=None, video_pth=None, label_mode='1', alpha=0.1, anno_mode=['Mask'], font_size=18):
    t = []
    ...
    visual = Visualizer(image_ori, metadata=metadata, mark_font_size=font_size)
